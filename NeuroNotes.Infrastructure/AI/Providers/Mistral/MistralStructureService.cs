...
namespace NeuroNotes.Infrastructure.AI.Providers.Mistral
{
    public class MistralStructureService : IStructureService
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            _logger.LogDebug("Sending structure request to Mistral. Model: {Model}", structureModel);
            ...
            try
            {
                ...
                if (!response.IsSuccessStatusCode)
                {
                    ...
                    _logger.LogError("Mistral Structure request failed. Status: {StatusCode}, Details: {ErrorContent}", response.StatusCode, errorContent);
                ...
                {
                    _logger.LogWarning("Mistral returned empty structure result.");
                    return string.Empty;
                }
            ...
            {
                _logger.LogError(ex, "Exception occurred during Mistral structure generation.");
                throw;
            }
        }
